...
def run_prescriptive_modelling():
    ...
    for feat in selected_feats:
        ...
        if target_val == avg_target:
            ...
            # Note: The original code used target_val - df[feat]. Keeping this logic.
    ...
    for feat in st.session_state.get("prescriptive_filtered_feats", selected_feats):
        ...
        new_val = df_mod[feat].mean() # Use the value calculated in the core logic block
        ...
        with col1:
            ...
            # The slider updates the session state, which triggers a re-run and recalculates df_mod at the top
            sens = st.slider(
